...
<div class="page-header">
    <h3 class="fw-bold mb-1"><i class="bi bi-person-plus-fill me-2"></i>Tambah Siswa Oleh Pembimbing Perusahaan</h3>
    <p class="text-muted mb-0">Buat akun siswa (username/email dan password) untuk perusahaan yang Anda bimbing.</p>
</div>
...
<div class="card card-modern">
    <div class="card-body p-4">
        ...
        <form action="{{ route('pembimbing.siswa.store') }}" method="POST">
            @csrf
                    ...
                    <tbody>
                        ...
                        @foreach($oldStudents as $i => $student)
                            <tr>
                                ...
                                <td>
                                    <select class="form-select" name="students[{{ $i }}][perusahaan_id]" required>
                                ...
                                <td><input type="email" class="form-control" name="students[{{ $i }}][email]" value="{{ $student['email'] ?? '' }}" placeholder="username@email.com"></td>
            ...
            <div class="small text-muted mb-4">
                Hanya perusahaan yang Anda bimbing yang bisa dipilih.
            </div>
            ...
            <template id="rowTemplate">
                <tr>
                    ...
                    <td>
                        <select class="form-select" name="students[__INDEX__][perusahaan_id]" required>
                            <option value="">- Pilih -</option>
                            @foreach($perusahaan as $item)
                    ...
                    <td><input type="email" class="form-control" name="students[__INDEX__][email]" placeholder="username@email.com"></td>
            ...
            <div class="d-flex gap-2">
                ...
                <a href="{{ route('pembimbing.dashboard') }}" class="btn btn-light border"><i class="bi bi-arrow-left me-1"></i>Kembali</a>
            </div>
        </form>
    </div>
</div>
