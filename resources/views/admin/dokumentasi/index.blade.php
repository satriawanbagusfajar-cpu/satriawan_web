                ...
                @foreach($dokumentasi as $dok)
                    <div class="col-md-3 col-6">
                        <div class="card border-0 shadow-sm rounded-3 overflow-hidden h-100">
                            <img src="{{ route('media.public', ['path' => $dok->foto], false) }}" class="card-img-top" style="height:180px; object-fit:cover; cursor:pointer;" alt="Dokumentasi" data-bs-toggle="modal" data-bs-target="#fotoModal{{ $dok->id }}">
