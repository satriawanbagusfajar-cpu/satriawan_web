                        ...
                        <tr>
                            ...
                            <td>
                                @if($item->foto)
                                    ...
                                    <img src="{{ asset('storage/' . $item->foto) }}" class="rounded" style="height:40px; width:40px; object-fit:cover; cursor:pointer;" alt="Foto" data-bs-toggle="modal" data-bs-target="#fotoAdm{{ $item->id }}">
                                @else
                                    <span class="text-muted">-</span>
                                @endif
                            </td>
