...
<div class="card card-modern mb-4">
    <div class="card-body p-4">
        <div class="text-center mb-4">
            ...
            @if($hariIni->foto)
                <div class="mt-3">
                    <img src="{{ asset('storage/' . $hariIni->foto) }}" class="rounded-3 shadow-sm" style="max-height:150px; cursor:pointer;" alt="Foto Check-in" data-bs-toggle="modal" data-bs-target="#fotoHariIni">
                    ...
                    <tr>
                        ...
                        <td>
                            @if($item->foto)
                                ...
                                <img src="{{ asset('storage/' . $item->foto) }}" class="rounded" style="height:40px; width:40px; object-fit:cover; cursor:pointer;" alt="Foto" data-bs-toggle="modal" data-bs-target="#fotoModal{{ $item->id }}">
                            @else
                ...
                <div class="modal-dialog modal-lg modal-dialog-centered">
                    <div class="modal-content border-0 rounded-4 overflow-hidden">
                        ...
                        <div class="modal-body text-center p-2">
                            <img src="{{ asset('storage/' . $item->foto) }}" class="img-fluid rounded-3" style="max-height:70vh;" alt="Foto Absensi">
                        </div>
                    </div>
                </div>
            </div>
...
<div class="modal fade" id="fotoHariIni" tabindex="-1">
    <div class="modal-dialog modal-lg modal-dialog-centered">
        <div class="modal-content border-0 rounded-4 overflow-hidden">
            ...
            <div class="modal-body text-center p-2">
                <img src="{{ asset('storage/' . $hariIni->foto) }}" class="img-fluid rounded-3" style="max-height:70vh;" alt="Foto Check-in">
            </div>
        </div>
    </div>
</div>
